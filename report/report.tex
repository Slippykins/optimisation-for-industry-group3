...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Wrote the Introduction (Section~\ref{sec:introduction}), Problem Definition (Section~\ref{sec:problem-definition}), and Data (Section~\ref{sec:data}) sections of the report.
    \end{itemize}
